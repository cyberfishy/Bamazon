-- Database Creation
CREATE DATABASE Bamazon;USE Bamazon;-- ============================ First Table ============================
...
INSERT INTO
  Departments(DepartmentName, OverHeadCosts, TotalSales)
VALUES
  ('grocery', 10500.00, -10000.00),
  -- More fun stuff (refunds for days!) ;)
  ('electronics', 25000.00, 0.00),
  ('sporting goods', 15000.00, 0.00),
  ('books', 5000.00, 0.00),
  ('dvds', 20000.00, 0.00),
  ('music', 7500.00, 0.00);-- View Database Entries
